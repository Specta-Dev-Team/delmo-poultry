(function () {
  ...
  const houses = [
    {
        id: "HUS001",
        code: "HUS001",
        name: "Layers Brooding House",
        stage: "Brooding",
        status: "Active",
        users: 4,
        houseCost: 0,
        batchId: "LY BATCH 001",
        flockAge: "26 weeks",
    ...
    },
    {
        id: "HUS002",
        code: "HUS002",
        name: "Layers Grower Annex",
        stage: "Grower",
        status: "Active",
        users: 3,
        houseCost: 0,
        batchId: "LY BATCH 002",
        flockAge: "18 weeks",
    ...
    },
    {
        id: "HUS003",
        code: "HUS003",
        name: "Layers Pre Layer House",
        stage: "Pre Layer",
        status: "Active",
        users: 5,
        houseCost: 68400,
        batchId: "LY BATCH 014",
        flockAge: "44 weeks",
    ...
    },
    {
        id: "HUS004",
        code: "HUS004",
        name: "Layers Layer House",
        stage: "Layer",
        status: "Active",
        users: 5,
        houseCost: 72000,
        batchId: "LY BATCH 015",
        flockAge: "48 weeks",
  ...
  async function loadHousesFromDataSource() {
    try {
      ...
      const dataSourceHouses = await window.LayersAPI.loadHouses();
  ...
  async function loadHouseDetailData(house) {
    ...
    try {
      if (typeof window.LayersAPI.loadSchedules === "function") {
        const schedules = await window.LayersAPI.loadSchedules({ house_id: house.id, batch_id: house.batchId });
        if (schedules.length) {
...
(function () {
  const AXPERT_DATASOURCES = {
    ...
    houses: { name: "poultry_layers_houses" },
    charts: { name: "poultry_layers_charts" },
    schedules: { name: "poultry_layers_schedules" },
  };
